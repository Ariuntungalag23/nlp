...
logging.basicConfig(
    filename="logs/tfidf_unigram_3models.log",
    level=logging.INFO,
...
OUTPUT_CSV = "/Users/ariuntungalag/Desktop/Natural_Lan/src/experiments/tfidf_unigram_60_3ev_results.csv"
...
logger.info("Building TF-IDF Unigram features")
...
logger.info("TF-IDF UNIGRAM (3 models) finished")
print("TF-IDF UNIGRAM (3 models) finished")