...
OUTPUT_CSV = f"/Users/ariuntungalag/Desktop/Natural_Lan/src/experiments/tfidf_{METHOD}_lstm_ngram_results.csv"
...
logger.info("TF-IDF NGRAM LSTM experiments finished")

print("TF-IDF NGRAM LSTM experiments finished!")
